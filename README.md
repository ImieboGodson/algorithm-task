...
These tasks were given to get the feel of basic JavaScript algorithms.
...
The script at [here](https://github.com/ImieboGodson/algorithm-task/blob/master/script.js) is my attempt at solving the tasks.